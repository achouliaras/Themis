...
#python PEBBLE_pretrain.py  domain=MiniGrid env=BlockedUnlockPickup-v0 render_mode=human seed=$seed num_unsup_steps=5000 num_train_steps=5000 num_interact=100 max_feedback=1000 reward_batch=8 reward_update=100 feed_type=$sample human_teacher=False agent.batch_size=256
python PEBBLE_train.py  domain=MiniGrid env=BlockedUnlockPickup-v0 render_mode=human seed=$seed num_unsup_steps=5000 num_train_steps=50000 num_interact=100 max_feedback=10000 reward_batch=8 reward_update=100 feed_type=$sample human_teacher=False agent.batch_size=256 debug=True
